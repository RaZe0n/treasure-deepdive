...
<div class="min-h-screen bg-gray-50 relative overflow-hidden">
    <!-- Top Wave -->
    <div class="absolute top-0 left-0 right-0 h-32 bg-red-500">
    ...
    <!-- Bottom Wave -->
    <div class="absolute bottom-0 left-0 right-0 h-32 bg-red-500">
    ...
    <div class="relative min-h-screen px-4 py-8">
        <div class="max-w-md mx-auto flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] gap-8">
            ...
            <div class="w-full max-w-[200px] aspect-square rounded-3xl shadow-xl overflow-hidden bg-white">
                <div class="h-full w-full bg-red-500 flex items-center justify-center">
                    <span class="text-3xl font-bold text-white">ROOD</span>
                </div>
            </div>
            ...
            <div class="w-full max-w-[280px] p-6 bg-white rounded-2xl shadow-lg">
                ...
                <p class="text-gray-600 text-center">Ga naar een coach wanneer je team compleet is</p>
            </div>
        </div>
    </div>
</div>
