...
<div class="bg-[url('../../public/img/background1.png')] bg-cover bg-center object-cover">
    ...
    <div class="flex justify-center items-center min-h-screen flex-col">
        <div class="flex items-center justify-evenly h-64 flex-col w-full">
            <div class="flex justify-evenly items-center h-3/5 w-3/5 flex-col">
                <h1 class="text-4xl font-IMfell text-center">Welkom bij de stadsbingo!</h1>
            </div>
            <div class="flex justify-evenly items-center h-3/5 w-3/5 flex-col p-1">
                    ...
                    <a class="bg-[#3289BB] rounded w-full font-Nunito text-3xl text-center block p-2" href="{{ url('/name') }}">Doorgaan</a>
            </div>
        </div>
    </div> 
</div>
